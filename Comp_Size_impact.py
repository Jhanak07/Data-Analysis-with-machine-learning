...
# Filter for female candidates who were invited for an interview and meet the graduation criteria
...
# Ensure we're considering all eligible interviews without missing any
# Segment data by company size and legislation period, ensuring full coverage
...
# Print results in sorted order by company size for readability
